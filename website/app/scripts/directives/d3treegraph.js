...
/**
 * @ngdoc directive
 * @name websiteApp.directive:d3TreeGraph
 * @description
 * # d3TreeGraph
 */
(function() {
    ...
    function d3TreeGraph() {
        return {
            restrict: 'A', // Directive Scope is Attribute
            //define the scope of the directive (customly via parameters of the html tag), or use parent scope
            // scope: false, //don't create a new scope (use scope of the parent)
            scope: {
                data: '=',
            //     xaxisName: '=',
            //     xaxisPos: '=',
            ...
            link: function (scope, elem, attrs) {
              ...
              // d3.json("/mbostock/raw/4063550/flare.json", function(error, flare) {
                ...
                root = scope.data;
                console.log("root from directive: " + root);
    ...
    angular.module('websiteApp')
      .directive('d3TreeGraph',d3TreeGraph);
})();
